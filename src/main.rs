...
use tch_vision::{
    alexnet, convnext, densenet, efficientnet, googlenet, imagenet, inception, maxvit, mnasnet,
    mobilenet_v2, mobilenet_v3, regnet, resnet, shufflenet_v2, squeezenet, swin_transformer, vgg,
    vision_transformer,
};
